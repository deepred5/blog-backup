...
title: git常用命令
description: git常用命令
pubDatetime: 2017-03-31T13:00:00.000Z
tags:
  - Git
---
...
* 推荐 《 [Dangit, Git!?!](https://dangitgit.com/zh#change-last-commit-message) 》
...
1.fork远程项目
在gitlab网页上进行操作
![fork2](@/assets/images/git常用命令/fork2.png)
...
![merge](@/assets/images/git常用命令/merge.png)
